"""
Copy of ogl_viewer without object detection and timestamp displayed on screen
"""
...
class GLViewer:
    ...
    def update_view(self, _image, _time):       # _objs of type sl.Objects
        self.mutex.acquire()
        # update image
        self.time = _time
